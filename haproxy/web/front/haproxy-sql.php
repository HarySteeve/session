...
<body>
    ...
    <div>
        ...
        <script>
            ////////////////////////////////
            // CRUD balance & server table
            ////////////////////////////////

            (async function loadBalanceMode() {
                try {
                    const resp = await fetch('<?= $controllerURL ?>?action=get-balance');
            ...
            (async function loadMysqlServers(){
                try{
                    const resp = await fetch('<?= $controllerURL ?>?action=list&backend=mysql_servers');
                    const data = await resp.json();
                    ...
                    console.warn('Could not load mysql servers', err);
                }
            })();
    ...
    <div>
        ...
        <form action="<?= $controllerURL ?>?action=add" id="addMysqlServerForm" method="post">
            <input type="hidden" name="backend" value="mysql_servers">
    ...
    <div>
        ...
        <form id="modifyMysqlServerForm" action="<?= $controllerURL ?>?action=update" method="post">
            <input type="hidden" name="backend" value="mysql_servers">
